...
public class artikel_kategori_seni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artikel_kategori_seni);

        item_artikel_kat adapter = new item_artikel_kat(artikel_kategori_seni.this, tv_lv, ic_lv);
