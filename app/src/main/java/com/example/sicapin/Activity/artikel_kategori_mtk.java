...
public class artikel_kategori_mtk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artikel_kategori_mtk);

        setContentView(R.layout.activity_artikel_kategori_mtk);
        item_artikel_kat adapter = new item_artikel_kat(artikel_kategori_mtk.this, tv_lv, ic_lv);
